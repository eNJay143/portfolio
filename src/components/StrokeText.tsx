...
const StrokeText = ({
  ...
  }, [box, dash, drawDuration, fillDelay, stagger, ease, trigger, fillMode, reverse]); // We purposefully omit onComplete from deps to prevent re-renders restarting the animation
